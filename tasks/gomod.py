...
def fetch_gomod_source(request, dep_replacements=None, package_configs=None):
    """
...
def _resolve_gomod(app_source_path, request, dep_replacements=None, git_dir_path=None):
    """
...
def _get_golang_version(module_name, git_path, commit_sha, update_tags=False, subpath=None):
    """
